...
Analytical professional with a unique blend of Data Analytics, Product Analytics, and AI Validation. Proven expertise in auditing AI-driven agents by scrutinizing Python execution plans and LLM logs to detect hallucinations and ensure high-fidelity data outputs. Skilled at navigating complex data schemas to identify trends, find bottlenecks, and optimize internal processes. Proficient in SQL and Python, with a dedicated focus on bridging the gap between technical LLM performance and actionable business metrics. 
